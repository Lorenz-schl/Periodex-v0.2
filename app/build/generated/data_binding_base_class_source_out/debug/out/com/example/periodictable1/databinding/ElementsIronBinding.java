...
public final class ElementsIronBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsIronBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsIronBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsIronBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_iron, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsIronBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsIronBinding((ConstraintLayout) rootView, constraintLayout, textView10,
