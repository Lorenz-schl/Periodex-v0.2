...
public final class ElementsBerylliumBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsBerylliumBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsBerylliumBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsBerylliumBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_beryllium, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsBerylliumBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsBerylliumBinding((ConstraintLayout) rootView, constraintLayout, textView10,
