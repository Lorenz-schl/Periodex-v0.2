...
public final class ElementsNitrogenBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsNitrogenBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsNitrogenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsNitrogenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_nitrogen, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsNitrogenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsNitrogenBinding((ConstraintLayout) rootView, constraintLayout, textView10,
