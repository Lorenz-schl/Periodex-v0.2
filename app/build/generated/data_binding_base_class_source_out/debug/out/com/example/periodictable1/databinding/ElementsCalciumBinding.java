...
public final class ElementsCalciumBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsCalciumBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsCalciumBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsCalciumBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_calcium, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsCalciumBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsCalciumBinding((ConstraintLayout) rootView, constraintLayout, textView10,
