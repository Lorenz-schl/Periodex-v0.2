...
public final class ElementsNickelBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsNickelBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsNickelBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsNickelBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_nickel, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsNickelBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsNickelBinding((ConstraintLayout) rootView, constraintLayout, textView10,
