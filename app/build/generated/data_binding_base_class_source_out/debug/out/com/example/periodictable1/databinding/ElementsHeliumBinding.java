...
public final class ElementsHeliumBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsHeliumBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsHeliumBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsHeliumBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_helium, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsHeliumBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsHeliumBinding((ConstraintLayout) rootView, constraintLayout, textView10,
