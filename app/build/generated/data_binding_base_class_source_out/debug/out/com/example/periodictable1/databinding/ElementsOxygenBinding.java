...
public final class ElementsOxygenBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsOxygenBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsOxygenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsOxygenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_oxygen, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsOxygenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsOxygenBinding((ConstraintLayout) rootView, constraintLayout, textView10,
