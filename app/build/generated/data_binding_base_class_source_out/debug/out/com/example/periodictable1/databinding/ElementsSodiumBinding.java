...
public final class ElementsSodiumBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsSodiumBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsSodiumBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsSodiumBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_sodium, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsSodiumBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsSodiumBinding((ConstraintLayout) rootView, constraintLayout, textView10,
