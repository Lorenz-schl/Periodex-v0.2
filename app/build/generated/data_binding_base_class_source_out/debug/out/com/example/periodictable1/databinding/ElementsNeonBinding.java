...
public final class ElementsNeonBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsNeonBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsNeonBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsNeonBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_neon, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsNeonBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsNeonBinding((ConstraintLayout) rootView, constraintLayout, textView10,
