...
public final class ElementsManganeseBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsManganeseBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsManganeseBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsManganeseBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_manganese, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsManganeseBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsManganeseBinding((ConstraintLayout) rootView, constraintLayout, textView10,
