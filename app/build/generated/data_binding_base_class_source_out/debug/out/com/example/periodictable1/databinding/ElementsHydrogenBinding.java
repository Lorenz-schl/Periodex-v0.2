...
public final class ElementsHydrogenBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsHydrogenBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsHydrogenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsHydrogenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_hydrogen, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsHydrogenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsHydrogenBinding((ConstraintLayout) rootView, constraintLayout, textView10,
