...
public final class ElementsPotassiumBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsPotassiumBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsPotassiumBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsPotassiumBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_potassium, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsPotassiumBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsPotassiumBinding((ConstraintLayout) rootView, constraintLayout, textView10,
