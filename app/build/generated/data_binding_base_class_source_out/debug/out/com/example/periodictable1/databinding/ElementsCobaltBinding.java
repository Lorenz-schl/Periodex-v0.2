...
public final class ElementsCobaltBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsCobaltBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsCobaltBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsCobaltBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_cobalt, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsCobaltBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsCobaltBinding((ConstraintLayout) rootView, constraintLayout, textView10,
