...
public final class ElementsBoronBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsBoronBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsBoronBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsBoronBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_boron, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsBoronBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsBoronBinding((ConstraintLayout) rootView, constraintLayout, textView10,
