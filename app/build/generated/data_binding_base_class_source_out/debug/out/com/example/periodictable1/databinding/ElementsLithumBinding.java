...
public final class ElementsLithumBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsLithumBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsLithumBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsLithumBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_lithum, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsLithumBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsLithumBinding((ConstraintLayout) rootView, constraintLayout, textView10,
