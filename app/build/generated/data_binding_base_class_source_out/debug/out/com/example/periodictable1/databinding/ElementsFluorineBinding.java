...
public final class ElementsFluorineBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsFluorineBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsFluorineBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsFluorineBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_fluorine, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsFluorineBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsFluorineBinding((ConstraintLayout) rootView, constraintLayout, textView10,
