...
public final class ElementsCarbonBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsCarbonBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsCarbonBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsCarbonBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_carbon, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsCarbonBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsCarbonBinding((ConstraintLayout) rootView, constraintLayout, textView10,
