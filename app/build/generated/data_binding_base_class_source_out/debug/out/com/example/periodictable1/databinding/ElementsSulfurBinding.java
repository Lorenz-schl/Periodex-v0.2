...
public final class ElementsSulfurBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsSulfurBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsSulfurBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsSulfurBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_sulfur, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsSulfurBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsSulfurBinding((ConstraintLayout) rootView, constraintLayout, textView10,
