...
public final class ElementsTitaniumBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsTitaniumBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsTitaniumBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsTitaniumBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_titanium, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsTitaniumBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsTitaniumBinding((ConstraintLayout) rootView, constraintLayout, textView10,
