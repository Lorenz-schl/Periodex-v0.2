...
public final class ElementsArgonBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsArgonBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsArgonBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsArgonBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_argon, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsArgonBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsArgonBinding((ConstraintLayout) rootView, constraintLayout, textView10,
