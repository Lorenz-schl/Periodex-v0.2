...
public final class ElementsChlorineBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsChlorineBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsChlorineBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsChlorineBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_chlorine, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsChlorineBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsChlorineBinding((ConstraintLayout) rootView, constraintLayout, textView10,
