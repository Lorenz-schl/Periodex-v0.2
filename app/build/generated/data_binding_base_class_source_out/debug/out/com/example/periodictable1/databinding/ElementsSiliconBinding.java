...
public final class ElementsSiliconBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsSiliconBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsSiliconBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsSiliconBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_silicon, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsSiliconBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsSiliconBinding((ConstraintLayout) rootView, constraintLayout, textView10,
