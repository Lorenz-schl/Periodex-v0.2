...
public final class ElementsZincBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsZincBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsZincBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsZincBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_zinc, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsZincBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsZincBinding((ConstraintLayout) rootView, constraintLayout, textView10,
