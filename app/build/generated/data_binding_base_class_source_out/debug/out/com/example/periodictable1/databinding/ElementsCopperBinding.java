...
public final class ElementsCopperBinding implements ViewBinding {
  @NonNull
  ...
  private ElementsCopperBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ElementsCopperBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ElementsCopperBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.elements_copper, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ElementsCopperBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ElementsCopperBinding((ConstraintLayout) rootView, constraintLayout, textView10,
